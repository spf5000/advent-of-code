...
const YEAR: Year = Year::Year2022;

pub struct Year2022 { }

impl Default for Year2022 {
    fn default() -> Self {
        Self {}
    }
}

impl crate::YearAnswers for Year2022 {
    fn get_answers_for_day(&self, day: u8) -> anyhow::Result<Box<dyn crate::DayAnswers>> {
        match day {
            ...
            // 19 => Ok(Box::new(day_19::Day19::default())),
            // 20 => Ok(Box::new(day_20::Day20::default())),
            // 21 => Ok(Box::new(day_21::Day21::default())),
            // 22 => Ok(Box::new(day_22::Day22::default())),
            // 23 => Ok(Box::new(day_23::Day23::default())),
            // 24 => Ok(Box::new(day_24::Day24::default())),
            // 25 => Ok(Box::new(day_25::Day25::default())),
